...
const GlobalStatistics: React.FC<GlobalStatisticsProps> = ({
	...
	return (
		<div className="mt-8 text-center">
			...
			<p>
				<span className="text-green-500 font-bold">Switch</span>: {switchWins}/
				{switchCount}, {switchWinRate.toFixed(2)}%
			</p>
			<p>
				<span className="text-red-500 font-bold">Stick</span>: {stickWins}/
				{stickCount}, {stickWinRate.toFixed(2)}%
			</p>
		</div>
	);
};
